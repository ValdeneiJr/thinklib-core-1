using UnityEditor;
using UnityEngine;
using Thinklib.Topdown.Enemy;

[CustomEditor(typeof(TopdownEnemyShooterAI))]
public class TopdownEnemyShooterAIEditor : Editor
{
    public override void OnInspectorGUI()
    {
        TopdownEnemyShooterAI ai = (TopdownEnemyShooterAI)target;
        ...
        if (ai.isPatroller)
        {
            ...
            ai.patrolSpeed = EditorGUILayout.FloatField("Patrol Speed", ai.patrolSpeed);
            ai.patrolTolerance = EditorGUILayout.FloatField("Patrol Tolerance", ai.patrolTolerance);
        }
